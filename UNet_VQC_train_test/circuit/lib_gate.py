...
Original file is located at
    https://colab.research.google.com/drive/1qTlucw_-4u1F_ZlE4UjiSeMWwfXgCaew
"""
...
class ExtendGate():
    ...
    def my_decompose_cccz(cls, circ, q1, q2, q3, q4, aux1, aux2):
        ...
        cls.fwd_ccx1(q3, q2, aux2)
        cls.my_decompose_cz(q3, q4)
        cls.bwd_ccx1(q3, q2, aux2)
    ...
    def my_decompose_ccz(cls, circ, q1, q2, q3, aux1):
        ...
        cls.my_decompose_cz(circ, q2, q3)
